...
extern int undo_manager_can_undo(const UndoManager *undo_manager);
extern int undo_manager_undo(UndoManager *undo_manager);
extern int undo_manager_all_undone(const UndoManager *undo_manager);
